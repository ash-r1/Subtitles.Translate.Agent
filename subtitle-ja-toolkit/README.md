...
| 4 | 翻訳 | `prompts/04-translate.md` | バッチ別の訳文 |
| 5 | 意味監査 | `prompts/05-semantic-review.md` | 意味エラーの検出・修正 |
| 6 | 口調・一貫性監査 ★新設 | `prompts/06-voice-consistency-review.md` | 人物らしさの検査・修正 |
| 7 | 日本語仕上げ | `prompts/07-polish-ja.md` | 自然さ・リズムの改善 |
| 8 | タイミング・改行調整 | `prompts/08-timing-adjust.md` | 表示時間延長・改行位置 |
| 9 | 最終整合性監査 ★新設 | `prompts/09-final-audit.md` | 作品横断の findings |
...
/translate-subtitles                  # Step 4–7: バッチ翻訳＋三重監査
/review-subtitles                     # Step 8–9: タイミング調整・SRT 生成・最終監査
```
...
翻訳してください。工程 1 から 9 まで順に実行し、各工程は対応する
prompts/NN-*.md の指示に従ってください。
```
...
python3 scripts/validate_batch.py work/batches/batch-000.json \
        work/04-translation/batch-000.json                     # 件数・ID・原文検証
...
- `samples/expected/` — Step 1〜9 の成果物と最終 SRT
